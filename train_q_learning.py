...
from board import gameConnect4
...
def write_games(n_games, wins, draws, avg_time):
    ...
    with open('trained_games_history.csv', 'a') as games_file:
        games_file.write(
...
while True:
    ...
    min_time = PINF
    average = 0
    process = Popen(['tail', '-n', '1', 'trained_games_history.csv'], stdout=PIPE)
    ...
    for i in range(1, GAMES + 1):
        ...
        start = time()
        game = gameConnect4()
        game.q_learning_algorithm(qdict, eps_0)
        end = time()
